...
public class JiaoLianCourseActivity extends BaseFragmentActivity {
...
//        //calendar.setSchemes();
    ...
    private void loadCalendar() {
        ...
        MyStringRequest stringRequest = new MyStringRequest(Request.Method.POST, Constants.plus(Constants.QUERY_TEACH_CALENDAR), new Response.Listener<String>() {
