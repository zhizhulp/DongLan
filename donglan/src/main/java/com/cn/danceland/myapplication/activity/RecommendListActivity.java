...
import com.cn.danceland.myapplication.adapter.RecommendAdapter;
...
public class RecommendListActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        title.setTitle(context.getResources().getString(R.string.recommend_list_text));
        ...
        btn_want.setText(context.getResources().getString(R.string.recommend_text));
    ...
    private void queryData() {
        MyStringRequest stringRequest = new MyStringRequest(Request.Method.POST, Constants.plus(Constants.QUERY_MY_RECOMMEND), new Response.Listener<String>() {
            @Override
