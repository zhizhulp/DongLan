...
public class TuankeRecylerViewAdapter extends RecyclerView.Adapter<TuankeRecylerViewAdapter.ViewHolder> {
    public List<CourseFindPerson.DataBean>  datas = null;
    private Context context;

    public TuankeRecylerViewAdapter(Context context, List<CourseFindPerson.DataBean>  datas) {
        this.datas = datas;
        this.context = context;
    }

    public void setData( List<CourseFindPerson.DataBean>  datas) {
        this.datas = datas;
    }
