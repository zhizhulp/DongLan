...
public class XiaoTuankeRecylerViewAdapter extends RecyclerView.Adapter<XiaoTuankeRecylerViewAdapter.ViewHolder> {
    public List<CourseMemberBean.Content>  datas = null;
    private Context context;

    public XiaoTuankeRecylerViewAdapter(Context context, List<CourseMemberBean.Content>  datas) {
        this.datas = datas;
