...
import com.cn.danceland.myapplication.activity.YeWuDetailsActivity;
...
public class YeWuRevisitListFragment extends BaseFragment {
...
//            }
            ...
            vh.ll_item.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(mActivity, YeWuDetailsActivity.class).putExtra("id", datalist.get(position).getId()).putExtra("auth", auth).putExtras(bundle));
                }
            });
