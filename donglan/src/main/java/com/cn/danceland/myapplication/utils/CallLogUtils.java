...
/**
 * Created by shy on 2018/1/12 19:32
...
public class CallLogUtils {
    ...
    public static String getCallHistoryList(Context context, ContentResolver cr) {
        ...
        if (cs != null && cs.getCount() > 0) {
            for (cs.moveToFirst(); !cs.isAfterLast() & i < 1; cs.moveToNext()) {//i是控制查多少条数据，查50条，i=50
    ...
    public static int getLastCallHistoryDuration(Context context, ContentResolver cr) {
