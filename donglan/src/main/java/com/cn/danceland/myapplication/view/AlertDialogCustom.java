...
public class AlertDialogCustom {
    ...
    public AlertDialogCustom(String ok, String cancle) {
        this.ok = ok;
        this.cancle = cancle;
    }

    public MyDialog CreateDialog(Context mcontext, String content, String hintContent, Click click) {
        this.mcontext = mcontext;
        this.click = click;
        LayoutInflater inflater = (LayoutInflater)
                mcontext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        layout = inflater.inflate(R.layout.notice_dialog, null);
