...
public class BatteryView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint1.setColor(getResources().getColor(R.color.color_dl_yellow));
    ...
    public void setmIsCharging(boolean mIsCharging) {
...
//            LogUtil.i("shouji--"+level+"**"+scale+"&&"+((float) level) / scale);
//        }
//    };
//
//    @Override
