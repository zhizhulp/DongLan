...
public class CustomMonthView extends MonthView {
    ...
    protected void onDrawScheme(Canvas canvas, Calendar calendar, int x, int y) {
        ...
        if (schemes != null && schemes.size() > 0) {
            ...
            if (schemes.size() == 2) {
                mPointPaint.setColor(schemes.get(0).getShcemeColor());
                canvas.drawCircle(x - 10 + mItemWidth / 2, y +mItemHeight - 3 * mPadding, mPointRadius, mPointPaint);
            ...
            if (schemes.size() == 3) {
                mPointPaint.setColor(schemes.get(0).getShcemeColor());
                canvas.drawCircle(x - 20 + mItemWidth / 2,y + mItemHeight - 3 * mPadding, mPointRadius, mPointPaint);
                mPointPaint.setColor(schemes.get(1).getShcemeColor());
                canvas.drawCircle(x + mItemWidth / 2,y + mItemHeight - 3 * mPadding, mPointRadius, mPointPaint);
