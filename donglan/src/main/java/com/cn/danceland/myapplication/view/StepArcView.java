...
/**
 * Created by shy on 2018/8/20 17:54
...
public class StepArcView extends View {
    ...
    private void init() {
         ...
         * 通过这个拿到一个资源图片对象
         */
        //    bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.s_left_jiantou);
...
//        drawBitmap(canvas);
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setStrokeCap(Paint.Cap.ROUND);//点变成圆形
    ...
    private void drawLine(Canvas canvas) {
        ...
        mPaint.setColor(getResources().getColor(R.color.color_dl_yellow));
        /**要绘制的表盘线的总数**/
        int count = 60;
        /**要绘制的表盘每个间隔线条之间的夹角**/
...
//                Log.d("stepView", point + "");
        ...
        progressAnimator.setRepeatCount(1);//重复几次
        progressAnimator.setRepeatMode(ValueAnimator.REVERSE);//重复方向
